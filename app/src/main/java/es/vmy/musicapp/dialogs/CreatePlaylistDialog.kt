...
class CreatePlaylistDialog(private val mListener: CreatePlaylistDialogListener): DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            ...
            val builder = AlertDialog.Builder(it)
                ...
                .setPositiveButton(getString(R.string.dialog_create)) { dialog, id ->
                    val playlistName = view.findViewById<TextInputEditText>(R.id.et_dialog_playlist_name).text.toString()
                    mListener.onCreatePlaylist(playlistName)
                    dismiss()
                }
